...
SAUCE_DEMO_INCORRECT_PASSWORD = os.getenv(
    "SAUCE_DEMO_INCORRECT_PASSWORD", "secret_sauce_incorrect"
)

SAUCE_DEMO_STANDARD_USER = os.getenv("SAUCE_DEMO_STANDARD_USER", "standard_user")
SAUCE_DEMO_INCORRECT_USER = os.getenv(
    "SAUCE_DEMO_INCORRECT_USER", "standard_user_incorrect"
)
...
SAUCE_DEMO_PERFORMACE_GLITCH_USER = os.getenv(
    "SAUCE_DEMO_PERFORMACE_GLITCH_USER", "performance_glitch_user"
)
